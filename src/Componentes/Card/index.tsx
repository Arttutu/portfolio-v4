    ...
    <div className={`flex flex-col gap-12 md:flex md:items-center md:pb-4 ${reverse ? 'md:flex-row-reverse' : 'md:flex-row'}`}>
      ...
      <div className="flex flex-col justify-center items-start p-4 gap-4 w-full md:w-1/2">
        <div className="flex flex-col gap-4">
          ...
          <h2 className="dark:text-white text-black text-left font-semibold text-xl">Tecnologias</h2>
          <span className="dark:text-white text-secundaria text-left text-md">{tech}</span>
        </div>
        <div className="flex flex-col gap-4">
          <p className="dark:text-gray-400 text-gray-950 text-xl">{descricao}</p>
