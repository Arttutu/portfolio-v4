    ...
    <section className="container mt-14 sm:mt-32 mx-auto">
      <div className=" lg:justify-around flex flex-col-reverse items-center gap-8 lg:flex lg:flex-row">
        <article className="flex flex-col items-center text-center sm:text-start w-100  sm:w-1/2 sm:items-start">
          <h1 className=" dark:text-white text-black text-4xl  sm:text-7xl font-semibold  after:content-['Arthur.'] after:sm:text-7xl after:text-4xl after:px-5 after:border-b-4 after:border-green-400">
            Oi, eu sou
          </h1>
          <h1 className=" dark:text-white text-black text-4xl  sm:text-7xl font-semibold sm: mt-5">
            Prazer em conhecer você!
          </h1>
          <p className=" dark:text-gray-400 text-gray-900   mt-10 text-base sm:text-lg ">
